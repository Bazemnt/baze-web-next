...
export default function PrivacyPage() {
  useEffect(() => {
    // Set page title
    document.title = 'Bazement — Privacy policy'
  }, [])
    ...
    <main>
      <section className={styles.pageWrapper}>
        ...
        >
          ...
          >
            <h1 className={styles.pageHeading}>Bazement Policy on User Privacy</h1>
            <div className={`${styles.textContent} ${styles.legalContent}`}>
              <p>This policy applies to ALL services, websites, apps, and projects directly provided by BAZEMENT LLC, (Bazement LLC), including testing, beta, and alpha releases unless another data-handling policy exists and explicitly overrides this policy by way of actual declaration. This policy applies to site visitors worldwide.</p>
              <p>This document does not cover third-party services or platforms that may interact with Bazement systems. Each third party has its own privacy policies, which will apply independently. Where we recognize a conflict between our policy and a third party's policy, we may try to inform the user, but we cannot take responsibility for third-party policies.</p>

              <h3>Cookies and Trackers</h3>
              <p>We do not use cookies or trackers to enhance your experience on our main site, bazement.xyz, except for one exception. We use a cookie to make our website live chat sessions work. The live chat is a self-hosted Chatwoot instance which gathers no user information. On Bazement projects, hosted, staged, or otherwise executed codebases, we may set cookies for the purpose of account and session management. In such a case, you will be informed of the cookie requirements.</p>

              <h3>Data Collection and Usage</h3>
              <p>Bazement collects contact information from users during the account creation and usage process. This includes:</p>
              <ul role="list">
